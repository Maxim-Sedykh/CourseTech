...
public class SubscriptionService : ISubscriptionService
{
    ...
    public async Task<Result<SubscriptionDto[]>> GetSubscriptionsAsync()
    {
        var subscriptions = await _subscriptionRepository.GetAll().ToListAsync();
        var subscriptionDtos = subscriptions.Select(MapToSubscriptionDto).ToArray();

        return Result<SubscriptionDto>.Success(subscriptionDtos);
    }
