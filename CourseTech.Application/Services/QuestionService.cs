...
public class QuestionService : IQuestionService
{
    ...
    public async Task<Result<QuestionDto[]>> GetQuestionsByCategoryAsync(int categoryId)
    {
        ...
        var questionDtos = questions.Select(q => MapToQuestionDto(q, category)).ToArray();

        return Result<QuestionDto[]>.Success(questionDtos);
    }
